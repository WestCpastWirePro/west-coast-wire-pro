...
const TOP25 = [
  ...
  { id:275, topic:"Motors", cat:"Motors & Transformers", diff:"Hard", q:"A motor feeder serves three motors: A=20A FLA, B=15A FLA, C=10A FLA. What is the minimum feeder conductor ampacity?", opts:["50A","53.75A","45A","60A"], ans:0, ref:"NEC 430.24", exp:"Per NEC 430.24: feeder ampacity = largest motor FLA × 125% + sum of all other motor FLAs. Largest motor = A at 20A. 20A × 1.25 = 25A. Add remaining: B=15A + C=10A = 25A. Total = 25 + 15 + 10 = 50A minimum feeder conductor ampacity. This is the most commonly tested motor feeder calculation on the CA exam." },
  { id:278, topic:"Motors", cat:"Motors & Transformers", diff:"Hard", q:"What is the maximum dual-element time-delay fuse rating for a 15 HP, 230V, single-phase motor?", opts:["175% of FLA","150% of FLA","300% of FLA","250% of FLA"], ans:0, ref:"NEC Table 430.52", exp:"Per Table 430.52 for single-phase AC motors: Dual-element (time-delay) fuse maximum = 175% of FLC. For inverse time circuit breaker = 250%. Non-time-delay fuse = 300%. Note: 150% applies to wound-rotor motors — not single-phase AC. Knowing the correct percentage per device type is critical — this table appears on virtually every exam." },
  ...
  { id:168, topic:"Box Fill", cat:"Calculations", diff:"Hard", q:"A box with four 12 AWG conductors, one EGC, and one duplex receptacle — what is the minimum box volume required?", opts:["11.25 cu. in.","18.00 cu. in.","13.50 cu. in.","15.75 cu. in."], ans:3, ref:"NEC 314.16(B)", exp:"Box fill: 4 conductors × 2.25 = 9 cu. in. 1 EGC (counted as one conductor regardless of how many) = 2.25 cu. in. 1 device (duplex = double allowance) = 2 × 2.25 = 4.50 cu. in. Total = 9 + 2.25 + 4.50 = 15.75 cu. in. → closest standard box = 18 cu. in. (4\" square, 1.5\" deep)." },
  ...
  { id:341, topic:"Load Calculations", cat:"Calculations", diff:"Hard", q:"A 2,400 sq ft dwelling with general lighting at 3 VA/sq ft, one small appliance circuit, and one laundry circuit — what is the calculated load before demand factors?", opts:["7,200 VA","12,200 VA","7,500 VA","10,200 VA"], ans:3, ref:"NEC 220.12 & 220.52", exp:"General lighting: 2,400 sq ft × 3 VA/sq ft = 7,200 VA (NEC 220.12). One small appliance circuit: 1,500 VA (NEC 220.52(A)). One laundry circuit: 1,500 VA (NEC 220.52(B)). Total before demand factors: 7,200 + 1,500 + 1,500 = 10,200 VA. Demand factors are then applied per NEC 220.42: first 3,000 VA at 100%, remainder at 35%." },
  ...
  { id:343, topic:"Voltage Drop", cat:"Calculations", diff:"Hard", q:"What AWG copper conductor limits voltage drop to 3% for 240V, 40A load, 75 ft from panel?", opts:["10 AWG","8 AWG","6 AWG","12 AWG"], ans:1, ref:"NEC 210.19(A)(1) Informational Note", exp:"Single-phase VD formula: CM = (2 × K × I × D) / VD. K=12.9 (copper), I=40A, D=75ft (one-way). VD allowed = 240V × 0.03 = 7.2V. CM = (2 × 12.9 × 40 × 75) / 7.2 = 77,400 / 7.2 = 10,750 CM. Next standard size above 10,750 CM: 10 AWG = 10,380 CM (not enough), 8 AWG = 16,510 CM ✓. Ampacity alone is satisfied by 10 AWG, but voltage drop forces the upsize to 8 AWG." },
]
