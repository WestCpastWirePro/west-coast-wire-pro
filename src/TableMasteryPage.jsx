...
const CARD_DATA = {
  ...
  "t_wire_area": {
    ...
    cards: [
      ...
      { front:"4 AWG THWN — area",   back:"0.0824 in²", hint:"2 fit in ¾\" EMT (31% fill = 0.165 in²); needs 1\" EMT for 3+ conductors" },
  ...
  "t8": {
    ...
    cards: [
      ...
      { front:"12 AWG copper — Ω/1000 ft",back:"1.98 Ω",    hint:"Used in alternate VD formula (Table 8 DC resistance at 75°C)" },
      { front:"10 AWG copper — Ω/1000 ft",back:"1.24 Ω",    hint:"Resistance drops as wire gets larger" },
