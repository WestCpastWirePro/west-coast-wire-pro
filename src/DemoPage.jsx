...
const DEMO_QUESTIONS = [
  ...
  {
    id: 5,
    mod: 'Module 5 — Services & Disconnects',
    modColor: '#8e44ad',
    ref: 'NEC 230.71(A)',
    diff: 'Medium',
    q: "What is the maximum number of service disconnecting means permitted for a single service?",
    opts: [
      'Three',
      'Four',
      'Two',
    ...
    ans: 3,
    exp: "NEC 2020 230.71(A) permits a maximum of six service disconnects per service. Each disconnect must be grouped in one location. The 'rule of six' is one of the most commonly tested service rules on the CA journeyman exam.",
  },
]
